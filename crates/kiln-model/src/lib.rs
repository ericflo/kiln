...
pub use backend::capability::{
    ...
    LinearRequestKind,
    MatmulAccumulation, MatmulBatchPolicy, MatmulCapabilities, MatmulEpilogue,
    MatmulOperandLayout, MatmulRequest, ReplayCapabilities, ReplayRequest, ReplayRequestKind,
