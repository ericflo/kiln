  ...
  const responses = {
    '/v1/config': () => ({
      ...
      accelerator_runtime: {
        ...
        full_attention_score_budget_mib: { configured: 2048, effective: 2048, source: 'default' },
        ...
        rocm_kernel_profile: { configured: 'qualified', effective: 'qualified', source: 'default' },
      ...
      rocm_graphs: {
        ...
        pre_candidate_headroom_phase: { calls: 0, slow: 0, total_duration_micros: 0, max_duration_micros: 0 },
        candidate_warm_phase: { calls: 0, slow: 0, total_duration_micros: 0, max_duration_micros: 0 },
        pre_native_reservation_phase: { calls: 0, slow: 0, total_duration_micros: 0, max_duration_micros: 0 },
        native_capture_phase: { calls: 0, slow: 0, total_duration_micros: 0, max_duration_micros: 0 },
        rejected_candidate_cleanup_phase: { calls: 0, slow: 0, total_duration_micros: 0, max_duration_micros: 0 },
      ...
      rocm_graphs_unavailable_reason: null,
      ...
      rocm_graph_telemetry_unavailable_reason: null,
      vram: {
      ...
      streaming_prefill: {
        dispatch: {
          ...
          effective: { policy: 'prompt_tokens_at_least', minimum_prompt_tokens: 2_048 },
          effective_source: 'backend_policy',
        },
        threshold_tokens: {
          configured: null,
          ...
          effective_for_auto_mode: 2_048,
          override_applied_to_backend_auto_policy: false,
        },
        tile_tokens: {
          configured: null,
          configured_source: 'default',
          backend_policy: 1_024,
          effective: 1_024,
          effective_source: 'backend_policy',
        },
        tape_tile_tokens: {
