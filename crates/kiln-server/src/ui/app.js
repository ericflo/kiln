  ...
  return `
    <div class="rc-groups">
      ...
      <div class="rc-group">
        ...
        ${runtimeConfigRow('ROCm kernel profile', `<strong>${escapeHtml(rocmKernelProfile.effective || '—')}</strong>${srcChip(rocmKernelProfile.source)}`, 'Complete immutable 35-leaf ROCm model policy. Portable fallback declines all 30 accelerated routes while retaining bounded training safeguards; experimental multiblock requires the experimental serving profile.')}
