  ...
  return `
    <div class="rc-groups">
      ...
      <div class="rc-group">
        ...
        ${runtimeConfigRow('ROCm kernel profile', `<strong>${escapeHtml(rocmKernelProfile.effective || '—')}</strong>${srcChip(rocmKernelProfile.source)}`, 'Complete immutable 46-leaf ROCm model/tensor policy. Portable fallback declines all 34 accelerated routes while retaining 12 correctness and bounded-work leaves; experimental multiblock requires the experimental serving profile.')}
