  ...
  return `
    <div class="rc-groups">
      ...
      <div class="rc-group">
        ...
        ${runtimeConfigRow('ROCm kernel profile', `<strong>${escapeHtml(rocmKernelProfile.effective || '—')}</strong>${srcChip(rocmKernelProfile.source)}`, 'Complete immutable 75-leaf ROCm model/tensor/flash policy. Portable fallback declines all 45 accelerated routes while retaining 30 correctness and bounded-work leaves; experimental multiblock requires the experimental serving profile.')}
