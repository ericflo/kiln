...
mod tests {
    ...
    async fn test_health_returns_ok() {
        ...
        assert_eq!(
            json["decode_runtime"]["accelerator_runtime"]["vulkan_device_policy_schema_id"],
        ...
        assert_eq!(
            json["decode_runtime"]["accelerator_runtime"]["full_attention_score_budget_mib"]["effective"],
            kiln_model::DEFAULT_FULL_ATTENTION_SCORE_BUDGET_MIB
        );
        assert!(
            json["decode_runtime"]["accelerator_runtime"]["vulkan_device_index"]["effective"]
                .is_null()
        );
        assert_eq!(
        ...
        assert_eq!(
            json["decode_runtime"]["accelerator_runtime"]["cuda_marlin_profile"]["effective"],
            "disabled"
        );
        assert_eq!(
            json["decode_runtime"]["accelerator_runtime"]["cuda_flash_backward_mode"]["effective"],
            "fast"
        );
        assert_eq!(
        ...
        assert_eq!(cuda_graphs["capture_allowed_by_serving_profile"], true);
