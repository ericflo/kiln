...
///
/// (#1082 metal-training) Also compiled under `metal`: the kt-native scope
/// machinery (`with_tape_authoritative_scope_kt` + the kt IO-mapping) is
/// device-agnostic; only the candle/CUDA-copy adapters inside stay
/// `#[cfg(feature = "cuda")]`.
