...
// Kiln: replaced c10 macros with CHECK_CUDA from hardware_info.h
#define C10_CUDA_CHECK(call) CHECK_CUDA(call)
#define C10_CUDA_KERNEL_LAUNCH_CHECK() CHECK_CUDA(cudaGetLastError())
