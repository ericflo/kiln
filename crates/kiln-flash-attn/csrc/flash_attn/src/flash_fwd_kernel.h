...
// Kiln: replaced philox_unpack.cuh (had ATen dependency)
...
inline __device__ void compute_attn_1rowblock(const Params &params, const int bidb, const int bidh, const int m_block) {
    ...
    // Kiln: inline unpack of KilnPhiloxState (no at::cuda::philox dependency)
    uint64_t philox_seed = params.philox_args.seed;
    uint64_t philox_offset = params.philox_args.offset;
    FLASH_NAMESPACE::Dropout dropout(philox_seed, philox_offset, params.p_dropout_in_uint8_t,
    ...
    if (Is_dropout && blockIdx.x == 0 && blockIdx.y == 0 && blockIdx.z == 0 && tidx == 0) {
        params.rng_state[0] = philox_seed;
        params.rng_state[1] = philox_offset;
    }
