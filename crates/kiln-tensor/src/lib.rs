...
#[cfg(feature = "metal")]
pub use metal_storage::{metal_softmax_last_axis, metal_zeros, MetalStorage};
#[cfg(feature = "vulkan")]
pub use vulkan_allocator::VulkanAllocator;
#[cfg(feature = "vulkan")]
pub use vulkan_storage::{
    vulkan_argmax_last_axis, vulkan_masked_fill, vulkan_softmax_last_axis, vulkan_zeros,
    VulkanStorage,
};
