...
pub use cuda_storage::{
    ...
    cuda_cumsum_axis, cuda_cumprod_axis, cuda_dropout, cuda_elementwise_binary, cuda_index_select_dim0, cuda_l2norm_last_axis, cuda_lerp,
...
pub use metal_storage::{
    metal_cast, metal_elementwise_binary, metal_index_select_dim0, metal_layernorm_last_axis,
    metal_rmsnorm_last_axis, metal_softmax_last_axis, metal_zeros, MetalStorage,
};
#[cfg(feature = "vulkan")]
...
pub use vulkan_storage::{
    ...
    vulkan_elementwise_binary, vulkan_l2norm_last_axis, vulkan_masked_fill,
