...
pub use method_api::{ArangeScalar, Dim, D};
...
pub use metal_storage::{
    host_to_metal_copy, metal_activation_unary, metal_adamw_step, metal_cast, metal_compare,
    metal_cumsum_axis, metal_elementwise_binary, metal_deep_copy, metal_index_select_dim0,
    metal_layernorm_last_axis, metal_log_softmax_last_axis, metal_rmsnorm_last_axis,
    metal_sdpa_last_axis, metal_softmax_last_axis, metal_to_host_copy, metal_where_select,
    primary_metal_companion, MetalStorage,
};
#[cfg(feature = "vulkan")]
