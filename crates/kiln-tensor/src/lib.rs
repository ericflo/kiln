...
pub use metal_storage::{
    metal_layernorm_last_axis, metal_rmsnorm_last_axis, metal_softmax_last_axis, metal_zeros,
    MetalStorage,
};
#[cfg(feature = "vulkan")]
...
pub use vulkan_storage::{
    vulkan_activation_unary, vulkan_argmax_last_axis, vulkan_elementwise_binary,
    vulkan_l2norm_last_axis, vulkan_masked_fill, vulkan_rmsnorm_last_axis,
