//! Vendored from candle-metal-kernels 0.10.2 `src/metal/device.rs`
//! (MIT/Apache-2.0). objc2 wrapper over `MTLDevice` — buffer / library /
//! pipeline / command-queue construction + the MLX-style device-type
