//! Vendored from candle-metal-kernels 0.10.2 `src/metal/command_buffer.rs`
//! (MIT/Apache-2.0). objc2 wrapper over `MTLCommandBuffer` + the
//! per-buffer encode-state semaphore. (#1082)
