...
const SHADER_SPIRVS: &[(&str, &[u8])] = &[
    ...
    (
        "linear_decode_argmax_batched_blocks_rows4_bf16w",
        SPIR_V_LINEAR_DECODE_ARGMAX_BATCHED_BLOCKS_ROWS4_BF16W,
    ),
    (
        "linear_decode_argmax_batched_blocks_rows8_bf16w",
        SPIR_V_LINEAR_DECODE_ARGMAX_BATCHED_BLOCKS_ROWS8_BF16W,
    ),
    (
    ...
    (
        "vk_rope_q_kv_write_slots_f32",
        SPIR_V_VK_ROPE_Q_KV_WRITE_SLOTS_F32,
    ),
    ...
    (
        ...
        SPIR_V_VK_MATMUL_LHS_T_BATCHED_F32,
    ),
    (
        "vk_matmul_lhs_t_batched_bf16",
        SPIR_V_VK_MATMUL_LHS_T_BATCHED_BF16,
    ),
    (
        "vk_matmul_rhs_t_batched_f32",
        SPIR_V_VK_MATMUL_RHS_T_BATCHED_F32,
    ),
    (
        "vk_matmul_rhs_t_batched_bf16",
        SPIR_V_VK_MATMUL_RHS_T_BATCHED_BF16,
    ),
