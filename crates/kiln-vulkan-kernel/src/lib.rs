...
pub mod shaders {
    ...
    pub const FULL_ATTN_QKV_GATE_SPLIT_BATCHED_BF16W: &str =
    ...
    pub const PAGED_KV_WRITE_SLOTS: &str = shader_path!("paged_kv_write_slots");
    ...
    pub const LINEAR_DECODE: &str = shader_path!("linear_decode");
    ...
    pub const GDN_IN_PROJ_DECODE_BATCHED_PAIR_QKV_Z_BF16W: &str =
        shader_path!("gdn_in_proj_decode_batched_pair_qkv_z_bf16w");
    pub const GDN_IN_PROJ_DECODE_BATCHED_PAIR_QKV_Z_ROWS2_BF16W: &str =
