...
const expectedApiCodeExamples = [
  { label: 'accelerator runtime v5 shape', terms: ['"accelerator_runtime"', '"schema_id": "kiln.accelerator-runtime-policy.v5"', '"version": 5', '"kt_api_mode"', '"full_attention_score_budget_mib"', '"configured": 2048', '"effective": 2048', '"rocm_synchronization_mode"', '"rocm_strided_batched_matmul_mode"', '"rocm_bf16_matmul_output_mode"', '"rocm_graph_mode"', '"rocm_graph_cache_entries"', '"rocm_graph_cache_max_bytes"', '"configured": 1073741824', '"effective": 1073741824'] },
...
const expectedArchitectureSections = [
  ...
  { label: 'immutable accelerator execution policy', terms: ['immutable accelerator routes, attention geometry, rocm stream ordering, and graph lifecycle', 'kiln.accelerator-runtime-policy.v5', 'adapter routes are one typed policy', 'accelerator.kt_api_mode', 'attention geometry cannot follow free-memory noise', 'accelerator.full_attention_score_budget_mib', '64–2048 MiB', 'materialized ceiling as high as 32 GiB', 'scoped programmatic hook', 'legacy_host_barriers', 'stream_ordered', 'one context, one policy', 'matmul route choice is fixed before inference', 'rocm_strided_batched_matmul_mode', 'rocm_bf16_matmul_output_mode', 'shape, and dtype', 'obsolete matmul trace variables were deleted', 'warmup_then_eager', 'lazy_capture_replay', 'workspace lease', 'rocm_graph_cache_max_bytes', 'default 1 GiB', 'retained_stable_io_bytes', 'retained_capture_arena_bytes', 'retained_blaslt_workspace_bytes', 'retained_slot_state_bytes', 'allocation identity', 'retained_bytes_accounting_complete=false', 'opaque_native_object_count', 'allocator-pool slack', 'least-recently-used idle owners', 'oldest access tick then slot ID', 'prior graph entries may be retired', 'continuity timeline remain intact', 'rocm_graph_cache_eviction', 'active_graph_only_owner_count', 'Tight', 'Critical or unavailable', 'pre-drop', 'post-drop', 'quarantined_retained_bytes', 'algorithm blobs are cached per device', '23 stable lower-snake-case reasons', 'capture_rollback', 'error_recovery', 'sticky STOP', 'cleanup-quarantined', 'active ROCm telemetry unavailability', 'central server admission gate', 'adapter, training, import', 'fails closed', 'kiln_rocm_cleanup_quarantined', 'decode_runtime.rocm_synchronization', 'decode_runtime.rocm_graphs', 'stable product default', 'fail startup outside the experimental profile', 'token/logit parity'] },
