...
const generatedDocsPages = [
  ...
  },
  {
    ...
    terms: [
      ...
      '15 top-level sections and 105 fixed leaf fields',
      '100 implement the canonical mechanical environment name',
      '69 also retain one or more deprecated compatibility spellings',
      '74 aliases total',
...
const expectedApiCodeExamples = [
  { label: 'accelerator runtime v8 shape', terms: ['"accelerator_runtime"', '"schema_id": "kiln.accelerator-runtime-policy.v8"', '"version": 8', '"vulkan_kernel_policy_schema_id": "kiln.vulkan-kernel-policy.v3"', '"vulkan_device_policy_schema_id": "kiln.vulkan-device-policy.v1"', '"kt_api_mode"', '"full_attention_score_budget_mib"', '"configured": 2048', '"effective": 2048', '"vulkan_device_index"', '"configured": null', '"effective": null', '"vulkan_validation"', '"configured": false', '"effective": false', '"rocm_synchronization_mode"', '"rocm_strided_batched_matmul_mode"', '"rocm_bf16_matmul_output_mode"', '"rocm_graph_mode"', '"rocm_graph_cache_entries"', '"rocm_graph_cache_max_bytes"', '"configured": 1073741824', '"effective": 1073741824'] },
