...
const generatedDocsPages = [
  ...
  },
  {
    ...
    terms: [
      ...
      '15 top-level sections and 111 fixed leaf fields',
...
const expectedApiCodeExamples = [
  { label: 'accelerator runtime v12 shape', terms: ['"accelerator_runtime"', '"schema_id": "kiln.accelerator-runtime-policy.v12"', '"version": 12', '"vulkan_kernel_policy_schema_id": "kiln.vulkan-kernel-policy.v3"', '"vulkan_device_policy_schema_id": "kiln.vulkan-device-policy.v1"', '"kt_api_mode"', '"full_attention_score_budget_mib"', '"configured": 2048', '"effective": 2048', '"vulkan_device_index"', '"configured": null', '"effective": null', '"vulkan_validation"', '"configured": false', '"effective": false', '"cuda_kernel_profile"', '"configured": "native_default"', '"effective": "native_default"', '"rocm_synchronization_mode"', '"rocm_strided_batched_matmul_mode"', '"rocm_bf16_matmul_output_mode"', '"rocm_kernel_profile"', '"configured": "qualified"', '"effective": "qualified"', '"rocm_graph_mode"', '"rocm_graph_cache_entries"', '"rocm_graph_cache_max_bytes"', '"configured": 1073741824', '"effective": 1073741824'] },
...
const expectedTroubleshootingSections = [
  ...
  { label: 'ROCm streaming-prefill pause/OOM diagnosis', terms: ['rocm long prefill pauses or runs out of memory', 'prefill_runtime.streaming_prefill', 'base/tape tiles of 256', 'server.max_prefill_tokens_per_cycle=256', 'startup rejects a mismatched route before loading model weights', 'detached/boundary/replay tiles of 8192', 'mode="disabled"', 'production actor serving keeps the route-invariant 256-token boundary', 'multiples of 64', 'do not broadly raise the timeout', 'hosted gpu ci is not hardware evidence'] },
...
function validateSftLossRouteDocumentationSourceContract() {
  ...
  const missingRocmSafetyTerms = missingNormalizedTerms(troubleshootingText, [
    ...
    'only reconciled thermal-only attribution may pass',
