...
const expectedTroubleshootingSections = [
  ...
  { label: 'ROCm decode-width selection', terms: ['ROCm decode-width selection', 'bounded, offline autotuner', 'widths 2, 4, and 8', 'one source-built release binary', 'fresh server process', '97 C package-temperature guard', '1,312 fixed deterministic output tokens', 'fused W8A8 sampled LM-head route reaches the same width', 'minimum of the deterministic and sampled throughput ratios', 'peak GPU allocation grows by more than 1 GiB', 'narrowest width within 2% of the best score', 'promotion above width 2', 'qualification-time autotuning, not online self-tuning', 'never changes a live scheduler', 'never mutates this field'] },
