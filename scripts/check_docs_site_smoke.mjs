...
const generatedDocsPages = [
  ...
  },
  {
    ...
    terms: [
      ...
      '15 top-level sections and 92 fixed leaf fields',
      '84 implement the canonical mechanical environment name',
      '60 also retain one or more deprecated compatibility spellings',
      '63 aliases total',
  ...
  },
  {
    ...
    terms: [
      ...
      'ApiError',
      'Payload components',
      '79 are field-complete',
      '39 remain migration pending',
      'migration pending',
    ],
  },
  {
  ...
  },
  {
    ...
    terms: [
      '921 direct read call sites',
      '376 process-mutation call sites',
      '374 distinct literal KILN_*',
...
const expectedApiCodeExamples = [
  { label: 'accelerator runtime v2 shape', terms: ['"accelerator_runtime"', '"schema_id": "kiln.accelerator-runtime-policy.v2"', '"version": 2', '"rocm_synchronization_mode"', '"rocm_graph_mode"', '"rocm_graph_cache_entries"', '"rocm_graph_cache_max_bytes"', '"configured": 1073741824', '"effective": 1073741824'] },
