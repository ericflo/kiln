...
const generatedDocsPages = [
  ...
  },
  {
    ...
    terms: [
      ...
      '16 top-level sections and 118 fixed leaf fields',
...
const expectedApiSections = [
  ...
  { label: 'complete effective configuration', terms: ['kiln.effective-configuration.v1', 'all 118 fixed typed startup leaves', 'two dynamic leaves for each teacher credential', 'post-precedence typed value', 'command_line', 'canonical and compatibility environment spellings', 'redacted null entries', 'kiln config --json'] },
