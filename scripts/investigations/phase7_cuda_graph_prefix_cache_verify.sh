...
KILN_ACCELERATOR_CUDA_MARLIN_PROFILE=attention_mlp \
KILN_MEMORY_CUDA_GRAPHS=true \
KILN_SPECULATIVE_METHOD=off \
KILN_PREFIX_CACHE_ENABLED=true \
KILN_PREFIX_CACHE_MAX_BLOCKS=${KILN_PREFIX_CACHE_MAX_BLOCKS:-2048} \
KILN_MEMORY_NUM_BLOCKS=${KILN_MEMORY_NUM_BLOCKS:-4096} \
KILN_MEMORY_KV_CACHE_FP8=${KILN_MEMORY_KV_CACHE_FP8:-true} \
