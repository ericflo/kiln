...
KILN_MODEL_SERVED_MODEL_ID="Qwen3.5-4B" \
KILN_MODEL_ADAPTER_DIR="$ADAPTER_DIR" \
KILN_SERVER_PORT="$PORT" \
KILN_SERVER_HOST=127.0.0.1 \
KILN_SERVER_EVAL_MODE=true \
KILN_SERVER_DEFAULT_THINKING_ENABLED=false \
KILN_MEMORY_NUM_BLOCKS="${KILN_MEMORY_NUM_BLOCKS:-256}" \
KILN_SERVER_REQUEST_TIMEOUT_SECS="${KILN_SERVER_REQUEST_TIMEOUT_SECS:-1200}" \
KILN_TRAINING_GRAD_CHECKPOINT_SEGMENTS="${KILN_TRAINING_GRAD_CHECKPOINT_SEGMENTS:-4}" \
