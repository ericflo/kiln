...
def build_openenv_types() -> None:
    ...
    add_object(
        ...
        "OpenEnvRunRequest",
        {
            ...
            "environment_reset_options": array({"type": "object"}, min_items=1),
            "max_steps": ref("PositiveInteger"),
            "concurrency": ref("PositiveInteger"),
            "max_action_tokens": ref("PositiveInteger"),
            "thinking_budget_tokens": ref("NonNegativeInteger"),
        ...
        "A persisted OpenEnv rollout or rollout-and-train request with optional static and paired held-out environment evaluation. Immutable train contracts are preflighted before persistence or environment collection. `environments` is accepted as an input alias for `environment_urls`.",
        optional=(
            "kind",
            "idempotency_key",
            "credential_ids",
    ...
    add_object(
        ...
        "OpenEnvRunStatus",
        {
            ...
            "warnings": array(ref("NonEmptyString")),
...
def build_examples() -> dict[str, list[Any]]:
    ...
    openenv_request = {
        ...
        "seed_start": 0,
        "reset_options": {},
        "environment_reset_options": [{"difficulty": "hard"}],
        "max_steps": 8,
        "concurrency": 4,
    ...
    openenv_status = {
        ...
        "warnings": ["One rollout produced no assistant tokens and was excluded."],
