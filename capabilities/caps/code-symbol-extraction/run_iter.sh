#!/usr/bin/env bash
# run_iter.sh — full OPD iter recipe for code-symbol-extraction.
#
# Pipeline:
...
OUT_ROOT="${OUT_ROOT:-/tmp/code-symbol-extraction-iter-${SLUG}}"
ADAPTER_NAME="${ADAPTER_NAME:-code-symbol-extraction-${SLUG}}"
