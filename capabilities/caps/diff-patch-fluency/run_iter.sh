#!/usr/bin/env bash
# run_iter.sh — full OPD iter recipe for diff-patch-fluency.
#
# Pipeline:
...
OUT_ROOT="${OUT_ROOT:-/tmp/diff-patch-fluency-iter-${SLUG}}"
ADAPTER_NAME="${ADAPTER_NAME:-diff-patch-fluency-${SLUG}}"
