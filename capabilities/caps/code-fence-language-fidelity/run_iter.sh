#!/usr/bin/env bash
# run_iter.sh — full OPD iter recipe for code-fence-language-fidelity.
#
# Pipeline:
...
OUT_ROOT="${OUT_ROOT:-/tmp/code-fence-language-fidelity-iter-${SLUG}}"
ADAPTER_NAME="${ADAPTER_NAME:-code-fence-language-fidelity-${SLUG}}"
