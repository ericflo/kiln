#!/usr/bin/env bash
# run_iter.sh — full OPD iter recipe for faithful-code-summarization.
#
# Pipeline:
...
OUT_ROOT="${OUT_ROOT:-/tmp/faithful-code-summarization-iter-${SLUG}}"
ADAPTER_NAME="${ADAPTER_NAME:-faithful-code-summarization-${SLUG}}"
