"""Per-iter B2 backup for pi-diff-patch-apply.

Mirrors capabilities/agentic-grpo/pi-compaction/backup_to_b2.py — uploads
the iter's adapter + rollouts + eval summaries + the cap scaffold itself
to B2, keyed by date + iter + kind.

B2 bucket: clouderic
Prefix: kiln/pi-diff-patch-apply/<YYYYMMDD>/iter-<n>-<kind>/
...
B2_BUCKET = "clouderic"
B2_PREFIX_BASE = "kiln/pi-diff-patch-apply"
