...
| 20+  | (smart_drive PIVOTED to default corpus) | —  | —      | **iter 20 onwards uses default train.tasks.jsonl** (matches eval distribution). Currently iter 20 in flight (h20-rank8-default-corpus = retry iter 12's recipe). |
