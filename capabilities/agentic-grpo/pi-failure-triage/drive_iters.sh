...
recipe_for_iter() {
  ...
  case "$n" in
    ...
    5)   echo "--kind train --lr 1e-5 --filter-var 0.0  --kl-coeff 0.05" ;;
    6)   echo "--kind train --lr 1e-5 --filter-var 0.02 --kl-coeff 0.2" ;;
    7)   echo "--kind train --lr 1e-5 --filter-var 0.02 --rank 8  --alpha 16" ;;
    8)   echo "--kind train --lr 1e-5 --filter-var 0.02 --rank 32 --alpha 64" ;;
    9)   echo "--kind train --lr 1e-5 --filter-var 0.02 --clip-eps 0.10" ;;
    10)  echo "--kind train --lr 1e-5 --filter-var 0.02 --clip-eps 0.30" ;;
    ...
    20)  echo "--kind train --lr 1e-5 --filter-var 0.02 --no-policy --echo-lambda 0.10" ;;
    ...
    24)  echo "--kind train --lr 1e-5 --filter-var 0.02 --kl-coeff 0.0" ;;
    25)  echo "--kind train --lr 1e-5 --filter-var 0.02 --kl-coeff 0.3" ;;
    ...
    31)  echo "--kind train --lr 1e-5 --filter-var 0.02 --clip-eps 0.15" ;;
    32)  echo "--kind train --lr 1e-5 --filter-var 0.02 --clip-eps 0.25" ;;
    ...
    43)  echo "--kind train --lr 1e-5 --filter-var 0.02 --kl-coeff 0.05" ;;
    44)  echo "--kind train --lr 1e-5 --filter-var 0.02 --kl-coeff 0.15" ;;
    45)  echo "--kind train --lr 1e-5 --filter-var 0.02 --adv-mode std_grpo" ;;
