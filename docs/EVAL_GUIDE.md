...
turn/session/model fields, source message index for trajectory rows, target
tools, prompt chars, target chars). This is the artifact that lets you later
explain what production workload slice an adapter score actually measured.
