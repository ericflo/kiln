...
Captured in `docs/archive/phase-c/phase-c51/environment.txt`:
...
nsys stats --report nvtxsum /tmp/kiln-post466-mtp.nsys-rep | tee docs/archive/phase-c/phase-c51/nsys-nvtxsum.txt || true
nsys stats --report gpukernsum /tmp/kiln-post466-mtp.nsys-rep | tee docs/archive/phase-c/phase-c51/nsys-gpu-kernsum.txt || true
nsys stats --report cudaapisum /tmp/kiln-post466-mtp.nsys-rep | tee docs/archive/phase-c/phase-c51/nsys-cuda-api.txt || true
```
...
Failure excerpt from `docs/archive/phase-c/phase-c51/nsys-profile.log`:
...
Raw profiler breadcrumb from `docs/archive/phase-c/phase-c51/nsys-raw-files.txt`:
...
No fresh post-#466 wall-clock percentages are available from this run. The top-three decode range fields in `docs/archive/phase-c/phase-c51/summary.json` are intentionally `null` rather than carrying stale percentages forward as if they were current.
