...
- `docs/archive/phase-c/phase-c8/c8_fix_report.md` (this file)
- `docs/archive/phase-c/phase-c8/c7_after_fix.txt` (full C7 comparator log, 6 pairs)
- `docs/archive/phase-c/phase-c8/c6_after_fix.txt` (full C6 comparator log, 6 pairs)
