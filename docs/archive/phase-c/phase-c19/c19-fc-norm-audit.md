...
From `docs/archive/phase-c/phase-c18/c18-h-prev-post-norm-fix.md` (Phase C19 handoff, item 1):
...
C13 already verified these load (`docs/archive/phase-c/phase-c13/mtp-weight-loading-audit.md`,
