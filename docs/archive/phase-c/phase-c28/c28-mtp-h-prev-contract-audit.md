...
From Phase C27 (`docs/archive/phase-c/phase-c27/c27-mtp-block-sequencing-audit.md`,
handoff section):
...
- Files inspected:
  ...
  - Prior-phase docs: `docs/archive/phase-c/phase-c18/c18-h-prev-post-norm-fix.md`,
    `docs/archive/phase-c/phase-c19/c19-fc-norm-audit.md`,
    `docs/archive/phase-c/phase-c27/c27-mtp-block-sequencing-audit.md`
...
refutation (`docs/archive/phase-c/phase-c19/c19-fc-norm-audit.md`). Re-verified here
