...
- **Dumps**: `/workspace/c7-dumps/{kiln,ref,cmp}/` on pod `5dnpt5zxqih7qf`. Full comparator log: `docs/archive/phase-c/phase-c7/c7_all.log` (382 lines, 6 pair verdicts + combined summary).
...
- Full comparator log: `docs/archive/phase-c/phase-c7/c7_all.log` (382 lines)
