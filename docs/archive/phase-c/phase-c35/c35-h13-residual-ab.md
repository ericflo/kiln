...
- [`docs/archive/phase-c/phase-c18/c18-mtp-initial-baseline.md`](../phase-c18/c18-mtp-initial-baseline.md)
  — original α=0.153 baseline measurement.

### Phase C34

- [`docs/archive/phase-c/phase-c34/c34-sampler-parity-audit.md`](../phase-c34/c34-sampler-parity-audit.md)
