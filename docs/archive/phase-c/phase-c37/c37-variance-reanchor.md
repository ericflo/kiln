...
- Stated "C36 seed 0 α = 0.6076." C36 §3 (`docs/archive/phase-c/phase-c36/c36-h14a-decode-length-sweep.md`) records seed 0 at L = 128 as α = **0.5875**. The 0.6076 value belongs to the C35 Cell D anchor.
