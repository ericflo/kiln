...
From [`docs/archive/phase-c/phase-c20/c20-mtp-block-norm-audit.md`](../phase-c20/c20-mtp-block-norm-audit.md)
...
- `docs/archive/phase-c/phase-c18/c18-h-prev-post-norm-fix.md` — origin of the H1/H2/H3
