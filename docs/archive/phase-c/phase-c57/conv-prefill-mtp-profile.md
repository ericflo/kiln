...
of truth after the status-3 prefill failure documented in `docs/archive/phase-c/phase-c56/`.
...
nsys stats --force-export=true \
  ...
  --format csv --output docs/archive/phase-c/phase-c57/c57-mtp-conv-prefill-v2 \
