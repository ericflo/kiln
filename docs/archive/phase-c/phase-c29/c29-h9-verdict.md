...
- Compare report (this doc's source data): `docs/archive/phase-c/phase-c29/c29-logits-compare.md`, `docs/archive/phase-c/phase-c29/c29-logits-compare.json`.
- Pod logs + per-seed C14 summary tarball: `docs/archive/phase-c/phase-c29/artifacts/`.
