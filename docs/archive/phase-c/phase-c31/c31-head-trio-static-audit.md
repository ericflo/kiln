...
C30 (`docs/archive/phase-c/phase-c30/c30-h11-accept-reject-audit.md`) refuted H11
...
C25's static audit (`docs/archive/phase-c/phase-c25/c25-verifier-vs-draft-logit-path.md`)
...
(`docs/archive/phase-c/phase-c19/c19-fc-norm-audit.md`) and C26
(`docs/archive/phase-c/phase-c26/c26-mtp-weight-reload-sanity.md`) independently verified
...
(`docs/archive/phase-c/phase-c18/c18-h-prev-post-norm-fix.md`, PR #347): prior to C18 the
...
C28 (`docs/archive/phase-c/phase-c28/c28-mtp-h-prev-contract-audit.md`) re-verified the fix
...
`docs/archive/phase-c/phase-c14/` + C29's re-run on 49 dumps give the cosine envelope for
...
`docs/archive/phase-c/phase-c29/c29-h9-verdict.md`:
...
C17 (`docs/archive/phase-c/phase-c17/c17-head-forward-first-divergence.md`) located the
...
C25 (`docs/archive/phase-c/phase-c25/c25-verifier-vs-draft-logit-path.md`) re-audited
...
The C1 summary (`docs/archive/phase-c/phase-c1/c1_summary.txt`) reports per-seed logit
medians:
