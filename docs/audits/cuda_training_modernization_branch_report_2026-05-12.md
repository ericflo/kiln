...
matmul, exact-batch batched matmul, and F32 softmax-last-dim ops prove that the tape can propagate
...
projection/attention-shaped matmul, and softmax Jacobian-vector products
