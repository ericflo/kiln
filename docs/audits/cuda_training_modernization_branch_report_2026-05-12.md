...
creates fresh CUDA GDN state per example over that mixed model step, but the production SFT route
still keeps the earlier FullAttention-only preflight.
