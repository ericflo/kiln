...
the per-token last-dim broadcast multiply needed for recurrent gate scaling, but these pieces are
not yet threaded through a recurrent GDN layer or full-model training step.
