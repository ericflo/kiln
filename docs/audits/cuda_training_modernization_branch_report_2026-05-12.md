...
GDN-state model step whenever imported CUDA weights contain LinearAttention/GDN layers, but this is
not yet validated on a real Qwen3.5-4B hybrid SFT job.
