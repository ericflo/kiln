...
division, scalar scale, F32/BF16 dtype casts, sum and mean reductions, reshape, 2D transpose, and 2D
matmul ops prove that the tape can propagate and accumulate gradients through real CUDA tensor ops,
including product and quotient rules, mixed-precision passthrough casts, scalar-loss reductions,
