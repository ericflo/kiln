...
causal conv q/k/v, gated RMSNorm, and LoRA output projection in isolation, but these pieces are not
yet threaded through a recurrent GDN layer or full-model training step.
