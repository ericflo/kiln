...
gradients, Qwen RMSNorm analytic `dX` with frozen base weights, RoPE inverse-rotation backward, and embedding lookup scatter-add. Initial unmasked and causal SDPA helpers plus a SwiGLU MLP helper now compose the native train-shell ops
