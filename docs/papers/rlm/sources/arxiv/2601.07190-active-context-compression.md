...
authors:
  - "Verma, Nikhil"
date: "2026/01/12"
online_date: "2026/01/12"
license_url: "http://creativecommons.org/licenses/by/4.0/"
source_url: "https://arxiv.org/abs/2601.07190v1"
pdf_url: "https://arxiv.org/pdf/2601.07190"
category: "adjacent-context-compression"
generated_utc: "2026-05-27T02:05:34+00:00"
---
...
- Source: https://arxiv.org/abs/2601.07190v1
- PDF: https://arxiv.org/pdf/2601.07190
- License: http://creativecommons.org/licenses/by/4.0/
- Authors: Verma, Nikhil
- RLM relevance: Active Context Compression studies autonomous agent-controlled pruning and compression in long-horizon SWE-style tasks.
- Related links:
- None recorded
...
3. 3.
   ...
   Context Poisoning: Long contexts filled with trial-and-error logs, failed tests, and verbose tool outputs can distract the model, leading to the “Lost in the Middle” phenomenon [[1](https://arxiv.org/html/2601.07190v1#bib.bib1)].

## II Related Work

Memory-Augmented Agents. Several approaches address context limitations through external memory. MemGPT [[2](https://arxiv.org/html/2601.07190v1#bib.bib2)] implements a virtual memory hierarchy inspired by operating systems, allowing LLMs to manage their own memory through explicit read/write operations. Voyager [[3](https://arxiv.org/html/2601.07190v1#bib.bib3)] uses a skill library to store reusable code snippets, reducing redundant exploration.

Reflection and Self-Improvement. Reflexion [[4](https://arxiv.org/html/2601.07190v1#bib.bib4)] enables agents to learn from failures by generating textual reflections stored in an episodic memory buffer. However, this operates between task attempts rather than within a single continuous trajectory. LATS [[5](https://arxiv.org/html/2601.07190v1#bib.bib5)] combines tree search with LLM reasoning but still accumulates full trajectories.

Context Compression. StreamingLLM [[6](https://arxiv.org/html/2601.07190v1#bib.bib6)] addresses infinite context through attention sink tokens, but operates at the attention level rather than providing agent-level memory management. LLMLingua [[7](https://arxiv.org/html/2601.07190v1#bib.bib7)] compresses prompts but requires a separate compression model.
...
3. 3.
   ...
   Consolidate: When the agent naturally completes the sub-task or hits a dead end, it decides to call complete\_focus, generating a summary of:
...
Following Anthropic’s reported best practices for SWE-bench [[8](https://arxiv.org/html/2601.07190v1#bib.bib8)], we implemented a minimal two-tool scaffold:
...
- •
  ...
  String-Replace Editor: Targeted file editing via exact string replacement (view, create, str\_replace, insert), avoiding error-prone full-file rewrites.
...
- •
  ...
  Mandatory workflow: “ALWAYS call start\_focus before ANY exploration… ALWAYS call complete\_focus after 10-15 tool calls”
- •

  Periodic reminders: After 15 tool calls without compression, the system injects: “REMINDER: You should call complete\_focus to compress your context”
- •
...
| seaborn-2848 | ×\times | ×\times | -52% | 7 |
| pylint-7080 | ✓ | ✓ | +110% | 8 |
| pytest-7490 | ✓ | ✓ | -18% | 6 |
| sympy-21171 | ×\times | ×\times | -57% | 4 |
...
4. 4.
   ...
   Scaffold Dependence: Our results use an optimized two-tool scaffold (bash + str\_replace\_editor). Different tool configurations may show different compression patterns.
...
- [2]
  ...
  C. Packer, S. Wooders, K. Lin, V. Fang, S. K. Patil, I. Stoica, and J. E. Gonzalez, “MemGPT: Towards LLMs as operating systems,” arXiv preprint arXiv:2310.08560, 2023.
- [3]
...
- [4]
  ...
  N. Shinn, F. Cassano, A. Gopinath, K. R. Narasimhan, and S. Yao, “Reflexion: Language agents with verbal reinforcement learning,” NeurIPS, 2023.
- [5]
...
- [8]
  ...
  Anthropic, “Claude’s scores on SWE-bench Verified,” Anthropic Blog, 2024. [Online]. Available: https://www.anthropic.com/research/swe-bench-sonnet
