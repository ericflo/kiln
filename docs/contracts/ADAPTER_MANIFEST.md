...
| `openenv_training_data` | no | Validated `kiln.openenv-training-data.v1` environment, schema, ordered group-plan, exact behavior-policy revision, seed, step, and termination identity copied from an all-OpenEnv GRPO receipt. |
