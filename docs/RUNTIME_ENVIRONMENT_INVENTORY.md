...
The scanner records **530 direct read call sites** and
**219 process-mutation call sites**. It can
statically name **74 distinct literal `KILN_*`
read names** across **177 call sites**.
