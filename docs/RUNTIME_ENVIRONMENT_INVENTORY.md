...
The scanner records **611 direct read call sites** and
**236 process-mutation call sites**. It can
statically name **129 distinct literal `KILN_*`
read names** across **246 call sites**.
...
|---|---:|---:|---:|
| Public stable | 9 | 1 | 0 |
| Experimental/debug migration | 144 | 88 | 0 |
