...
The scanner records **435 direct read call sites** and
**19 process-mutation call sites**. It can
statically name **31 distinct literal `KILN_*`
read names** across **115 call sites**.
