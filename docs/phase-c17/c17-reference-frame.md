...
From `docs/phase-c15/c15-h-main-drift-verdict.md` (FP32 column, reproduced for traceability):
...
- This document.
- Companion verdict: `docs/phase-c17/c17-head-forward-first-divergence.md`.
