...
| 2026-07-09 | Deadline-safe qualification stream reads | `sha256:42578a58f034` | this commit | portable | mixed-load stream-reader and cancellation regressions | passed | Readiness polling now enforces request and cleanup deadlines without timing out and poisoning `HTTPResponse`'s buffered reader; 34 focused and 174 total qualification tests passed |
