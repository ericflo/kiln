...
| 2026-07-09 | Backpressure health contract | `sha256:613bf86ee1d9` | this commit | portable | `/health.decode_runtime.batching_engine` | passed | Health exposes the same saturation, wait, eviction, and closed-receiver counters as debug state and Prometheus; focused serialization test and formatting passed |
