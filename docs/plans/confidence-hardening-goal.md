...
| 2026-07-09 | ROCm mixed-load qualification contract | `sha256:9ba9a989d350` | this commit | Strix Halo ROCm target | `qualification/workloads/serving-mixed-rocm-v1.json` | passed | Four source-bound A/B arms cover batching, long prefill, cancellation, attributed socket pressure, actor-ready timing, graph execution, memory, and fail-closed policy checks; 29 focused and 169 total qualification tests passed |
