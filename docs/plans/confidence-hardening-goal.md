...
| 2026-07-09 | Local qualification operator guide | `sha256:9d68b2504fe4` | this commit | local hardware | `docs/qualification.md` | passed | Clean-tree setup, workload execution, strict validation, comparison, artifact policy, and receipt check-in are documented for new machines |
