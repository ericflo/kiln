...
| `openenv.max_tracked_runs` | unsigned integer; `128` | `KILN_OPENENV_MAX_TRACKED_RUNS` (implemented) | none | Must be greater than zero and at least `max_active_runs`. This is the hard admission bound for active plus FIFO-queued work and retained terminal history. |
