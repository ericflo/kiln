...
| `DecodeBatcherPolicy` | 10 | `max_batch`, `wait_micros`, `allow_mixed_seq_lens`, `rowwise_retry_env`, `prefer_direct_paged_decode_attention`, `direct_paged_decode_attention_env_gate`, `use_greedy_token_decode`, `use_native_sampled_contiguous_decode`, `sampled_contiguous_decode_requires_resident_decode`, `partition_noncontiguous_gdn_kv_tiles` |
