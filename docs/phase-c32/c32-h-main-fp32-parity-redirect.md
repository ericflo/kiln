...
`docs/phase-c31/c31-head-trio-static-audit.md` §6.1) as the last untested
...
modes were run. See `docs/phase-c15/c15-h-main-drift-verdict.md`.
...
`docs/phase-c29/` and PR #355 ran 49 paired kiln/HF dumps (4 prompt
...
Per `docs/phase-c31/c31-head-trio-static-audit.md` §3, the trio
...
- `docs/phase-c15/c15-h-main-drift-verdict.md` — original independent fp32 audit
- `docs/phase-c15/c15_audit_fp32.json` — per-step fp32 numbers
- `docs/phase-c18/c18-h-prev-post-final-norm-verdict.md` — fix verdict
- `docs/phase-c29/c29-mtp-logits-h9-verdict.md` — 49-dump empirical head check
- `docs/phase-c31/c31-head-trio-static-audit.md` — head-trio bisect
