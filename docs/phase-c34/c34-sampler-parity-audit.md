...
- [`docs/phase-c18/...`](../phase-c18) — α baseline (median 0.1532)
- [`docs/phase-c22/c22-fc-residual-audit.md`](../phase-c22/c22-fc-residual-audit.md)
  — handed off H5 to C23
- [`docs/phase-c23/c23-draft-sampler-audit.md`](../phase-c23/c23-draft-sampler-audit.md)
  — H5 disproven: intra-kiln draft vs verifier sampler parity (PR #348)
- [`docs/phase-c32/c32-h-main-fp32-parity-redirect.md`](../phase-c32/c32-h-main-fp32-parity-redirect.md)
  — MTP head FP32 parity doc-only redirect
- [`docs/phase-c33/c33-mtp-finetune-static-audit.md`](../phase-c33/c33-mtp-finetune-static-audit.md)
