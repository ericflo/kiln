...
From [`docs/phase-c18/c18-h-prev-post-norm-fix.md`](../phase-c18/c18-h-prev-post-norm-fix.md)
...
C13's weight-loading audit (`docs/phase-c13/mtp-weight-loading-audit.md`,
