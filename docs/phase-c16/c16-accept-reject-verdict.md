...
**Scope (from C15 handoff, `docs/phase-c15/c15-h-main-drift-verdict.md` §"Handoff to C16")**: audit the path from validated-stable `h_main` through MTP head-0 output to the accept/reject decision, covering four candidate α-collapse causes downstream of `h_main`:
